...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
quizUsers.push(new QuizUser('Paul', 'paul@gmail.com', 'something', '74'));
quizUsers.push(new QuizUser('Brandon', 'brandon@ymail.com', 'something2', '83'));
quizUsers.push(new QuizUser('Jake', 'jake@yahoo.com', 'something3', '86'));
...
var question3 = new Question('T/F: In Javascript, == doesn\'t check \'type\' but just the value - where === checks type and value', ['T', 'F'], 'F', 'Easy')
